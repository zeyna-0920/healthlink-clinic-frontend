      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <Card className="p-6 bg-primary/10 border-primary/30 shadow-[var(--shadow-soft)]">
            ...
            <p className="text-sm text-foreground/80">
              Faciliter l'accès aux soins médicaux grâce à la digitalisation : prise de rendez-vous
              en ligne, téléconsultation et gestion intelligente des hospitalisations.
            </p>
          </Card>
          ...
          <Card className="p-6 bg-destructive/10 border-destructive/30 shadow-[var(--shadow-soft)]">
            ...
            <p className="text-sm text-foreground/80">
              Bienveillance, excellence, transparence et innovation guident chacune de nos actions
              au quotidien.
            </p>
          </Card>
          <Card className="p-6 bg-medical/10 border-medical/30 shadow-[var(--shadow-soft)]">
            ...
            <p className="text-sm text-foreground/80">
              Médecins, infirmiers et sages-femmes passionnés, à votre écoute 24h/24 pour les
              urgences et de 8h à minuit pour les consultations.
            </p>
          </Card>
        </div>
        ...
        <Card className="p-8 bg-[image:var(--gradient-soft)] border-primary/20">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            des consultations à distance, nous contribuons à un système de santé plus efficace et
            plus humain. Notre plateforme vous permet de suivre vos rendez-vous, vos ordonnances et
            votre dossier médical en toute sécurité.
          </p>
        </Card>
      </div>
    </div>
