...
import { ArrowLeft, Edit, Save, X, User, Mail, Phone, Calendar, MapPin, Heart, AlertTriangle } from "lucide-react";
...
import { getPatient, updatePatient } from "../api/-clinic";
...
export const Route = createFileRoute("/patients/$patientId")({
  ...
  loader: async ({ params }) => {
    // Dans un vrai projet, on chargerait les données ici
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  {editing ? (
                    ...
                    <p className="text-sm text-muted-foreground">{patient.gender === "M" ? "Masculin" : patient.gender === "F" ? "Féminin" : patient.gender || "Non spécifié"}</p>
                  )}
                </div>
              </div>
            </Card>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  {editing ? (
                    ...
                    <p className="text-sm text-muted-foreground">{patient.bloodType || "Non spécifié"}</p>
                  )}
                </div>
                <div className="space-y-2">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span>{patient.registrationDate ? new Date(patient.registrationDate).toLocaleDateString("fr-FR") : "—"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Dernière consultation</span>
                  <span>{patient.lastConsultation ? new Date(patient.lastConsultation).toLocaleDateString("fr-FR") : "—"}</span>
                </div>
                <div className="flex justify-between">
