...
export function EmergencyButton() {
  return (
    <Link
      to="/contact"
      className="fixed bottom-6 right-6 z-40 flex items-center gap-2 rounded-full bg-destructive px-5 py-3 text-destructive-foreground shadow-[0_8px_30px_-8px_oklch(0.6_0.22_27/0.5)] hover:scale-105 transition-transform"
    >
